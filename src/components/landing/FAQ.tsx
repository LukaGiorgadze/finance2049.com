...
const FAQ = () => (
  ...
  >
    ...
    {/* Side decoration */}
    <svg className="absolute left-8 top-1/2 -translate-y-1/2 w-[3px] h-[300px] opacity-[0.12] pointer-events-none" viewBox="0 0 3 300">
      <line x1="1.5" y1="0" x2="1.5" y2="300" stroke="hsl(var(--primary))" strokeWidth="1" strokeDasharray="4 8" />
    </svg>
    <svg className="absolute right-8 top-1/2 -translate-y-1/2 w-[3px] h-[300px] opacity-[0.12] pointer-events-none" viewBox="0 0 3 300">
      <line x1="1.5" y1="0" x2="1.5" y2="300" stroke="hsl(var(--primary))" strokeWidth="1" strokeDasharray="4 8" />
    </svg>
    ...
    <div className="container relative z-10 max-w-3xl">
      ...
      >
        ...
        <h2 id="faq-title" className="text-4xl md:text-5xl font-bold tracking-tight">
          Got questions?
        </h2>
        <p
          id="faq-description"
        ...
        <Accordion type="single" collapsible aria-label="Frequently asked questions" className="space-y-3">
          {faqs.map((faq, i) => (
            <AccordionItem
              ...
              className="overflow-hidden rounded-2xl border border-border/70 bg-white px-6 shadow-[0_20px_60px_-40px_rgba(15,23,42,0.18)] hover:border-primary/20 hover:shadow-[0_24px_70px_-36px_rgba(52,199,89,0.2)] dark:border-white/10 dark:bg-white/[0.04] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] dark:hover:border-white/15 dark:hover:bg-white/[0.06] dark:hover:shadow-[0_24px_70px_-40px_rgba(99,102,241,0.2)]"
            >
              <AccordionTrigger className="text-left text-sm cursor-pointer font-medium hover:no-underline dark:text-white">
