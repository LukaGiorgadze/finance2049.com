  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10">
        <motion.div {...getInViewProps()} className="mx-auto mb-16 max-w-3xl space-y-4 text-center">
            ...
            <motion.div
              ...
              className={`group relative flex h-full flex-col overflow-hidden rounded-2xl p-8 transition-all duration-300 ${
                plan.featured
                  ...
                  : "border border-white/10 bg-white/[0.03] shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] md:hover:-translate-y-1 md:hover:border-white/15 md:hover:bg-white/[0.05]"
              }`}
            >
              ...
              <div className="relative z-10 flex h-full flex-col">
                ...
                <Button
                  ...
                  className={
                    plan.featured
                      ? "group border border-primary/20 bg-primary font-semibold text-primary-foreground shadow-[0_18px_40px_-20px_hsl(var(--primary)/0.75)] transition-all duration-300 md:hover:-translate-y-0.5 md:hover:bg-primary/95 md:hover:shadow-[0_24px_50px_-20px_hsl(var(--primary)/0.9)] focus-visible:ring-primary/30"
                      : "group border border-white/10 bg-white/[0.04] text-white transition-all duration-300 md:hover:-translate-y-0.5 md:hover:border-primary/20 md:hover:bg-white/[0.07]"
                  }
                >
                  {plan.cta}
                </Button>
