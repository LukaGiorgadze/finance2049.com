      ...
      <div role="list" className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {reviews.map((r, i) => (
          <motion.article
            ...
            className="group relative flex h-full flex-col gap-4 overflow-hidden rounded-2xl border border-border/70 bg-white p-6 shadow-[0_20px_60px_-40px_rgba(15,23,42,0.22)] transition-transform duration-200 hover:-translate-y-1 hover:border-primary/20 hover:shadow-[0_24px_70px_-36px_rgba(52,199,89,0.22)] dark:border-white/10 dark:bg-white/[0.04] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] dark:hover:border-white/15 dark:hover:bg-white/[0.06] dark:hover:shadow-[0_24px_70px_-40px_rgba(99,102,241,0.22)]"
          >
            <div
              aria-hidden="true"
