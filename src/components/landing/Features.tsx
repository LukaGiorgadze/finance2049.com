        ...
        <div role="list" className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {features.map((f, i) => (
            <article
              key={f.title}
              role="listitem"
              className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] transition-all duration-300 md:hover:-translate-y-1 md:hover:border-white/15 md:hover:bg-white/[0.05]"
            >
              <div
                aria-hidden="true"
